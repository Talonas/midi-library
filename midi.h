...
enum midi_commands
{
	...
	MIDI_CMD_AFTERTOUCH = 0xA,
	MIDI_CMD_CONTROL_CHANGE = 0xB,
	MIDI_CMD_PROGRAM_CHANGE = 0xC,
	MIDI_CMD_CHANNEL_PRESSUER = 0xD,
	MIDI_CMD_PITCH_BEND = 0xE,
	MIDI_CMD_NON_MUSICAL = 0xF,
};
